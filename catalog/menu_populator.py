...
menuItem1 = MenuItem(
    name="French Fries", description="with garlic and parmesan",
...
menuItem4 = MenuItem(
    name="Sirloin Burger", description="Made with grade A beef",
...
menuItem2 = MenuItem(
    ...
    description=("A common Chinese dumpling which generally consists of minced "
                 "meat and finely chopped vegetables wrapped into a piece of "
                 "dough skin. The skin can be either thin and elastic or "
                 "thicker."),
...
menuItem3 = MenuItem(
    name="Gyoza",
    description=("The most prominent differences between Japanese-style gyoza "
                 "and Chinese-style jiaozi are the rich garlic flavor, which "
                 "is less noticeable in the Chinese version, the light "
                 "seasoning of Japanese gyoza with salt and soy sauce, and "
                 "the fact that gyoza wrappers are much thinner."),
...
menuItem2 = MenuItem(
    name="Chicken and Rice", description="Chicken... and rice",
...
menuItem4 = MenuItem(
    ...
    description=("Chicken marinated in yoghurt and seasoned with a spicy "
                 "mix(chilli, tamarind among others) and slow cooked in a "
...
menuItem2 = MenuItem(
    name="Cachapa",
    description=("Golden brown, corn-based Venezuelan pancake; usually "
                 "stuffed with queso telita or queso de mano, and possibly "
                 "lechon. "),
    price="$7.99", course="Entree", restaurant=restaurant1)
